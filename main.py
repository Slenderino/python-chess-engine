...
class Board:
    ...
    def load_pieces(self):
        global square_dim
        global piece_size
        base_path = "E:\\Documents\\Projectos\\Python\\chess-engine"
        images = {
            "P": pygame.image.load(str(base_path + "\\res\\wp.png")),
            "R": pygame.image.load(str(base_path + "\\res\\wr.png")),
            "N": pygame.image.load(str(base_path + "\\res\\wn.png")),
            "B": pygame.image.load(str(base_path + "\\res\\wb.png")),
            "Q": pygame.image.load(str(base_path + "\\res\\wq.png")),
            "K": pygame.image.load(str(base_path + "\\res\\wk.png")),
            "p": pygame.image.load(str(base_path + "\\res\\p.png")),
            "r": pygame.image.load(str(base_path + "\\res\\r.png")),
            "n": pygame.image.load(str(base_path + "\\res\\n.png")),
            "b": pygame.image.load(str(base_path + "\\res\\b.png")),
            "q": pygame.image.load(str(base_path + "\\res\\q.png")),
            "k": pygame.image.load(str(base_path + "\\res\\k.png")),
        }
